...
- [`FisherInformationEffectiveDimension.ipynb`](https://github.com/uborso/Quantum-ML-Semester-Project/blob/main/Code/FisherInformationEffectiveDimension.ipynb): Here we focus on evaluating a Quantum Neural Network (QNN) model. The key steps include:
...
- [`EntanglingCapability.ipynb`](https://github.com/uborso/Quantum-ML-Semester-Project/blob/main/Code/EntanglingCapability.ipynb): This notebook focuses on examining the impact of entanglement on QNNs using the Meyer-Wallach measure. This measure evaluates the entangling capabilities of feature maps and variational circuits, correlating them with performance metrics like effective dimension and Fisher information spectrum. The key steps include:
...
- [`Plots.ipynb`](https://github.com/uborso/Quantum-ML-Semester-Project/blob/main/Code/Plots.ipynb): This notebook is used for generating the figures included in the final thesis report. In particular it uses `matplotlib` library to plot the Effective Dimesnion and Fisher Information Spectrum for the different QNN structures analysed in this work.
